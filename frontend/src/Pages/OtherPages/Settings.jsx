...
const Settings = () => {
  ...
  return (
    ...
    <Navbar/>
     <Flex pt={90} w="90%" m="auto" >
        <Box w={["15%","15%","15%","25%"]} border="2px solid #b8b8b8" borderRight="none" backgroundColor="white">
          {
...
<Box pt={10}>
<hr />
<Text display={["none","none","none","block"]} p={2} textAlign='center' color="blue">Account Center</Text>
<Text display={["none","none","none","block"]} w="80%" m='auto'>Control settings for connected experiences across Instagram, the Facebook app and Messenger, including story and post sharing and logging in.</Text>
</Box>
</Box>
        <Box border="2px solid #b8b8b8" w={["85%","85%","85%","70%"]} backgroundColor="white">
          {
